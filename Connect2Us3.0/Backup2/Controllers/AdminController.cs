...
namespace book2us.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserName,Password,Email,Role,FirstName,LastName,Address,City,State,PostalCode,Country,Phone,Gender,Age,ProfilePicture")] ApplicationUser user)
        {
            if (ModelState.IsValid)
            {
